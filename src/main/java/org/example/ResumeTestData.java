...
public class ResumeTestData {
    ...
    private static List<String> createAchievements() {
        return Arrays.asList(
                ...
                "С 2013 года: разработка проектов \"Разработка Web приложения\",\"Java Enterprise\","
                        ...
                        + " (JAX-RS/SOAP). Удаленное взаимодействие (JMS/AKKA)\". Организация онлайн стажировок"
    ...
    private static List<Organization> createExperience() {
        return Arrays.asList(
                        ...
                        Arrays.asList(
                                new Position(
                                        ...
                                        "Проектирование и разработка онлайн платформы управления проектами Wrike (Java"
                                                ...
                                                + " Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT"
                                                + " SSO."))),
                new Organization(
                        "RIT Center",
                        null,
                        Arrays.asList(
                                new Position(
                                        YearMonth.of(2012, 4),
                                        YearMonth.of(2014, 04),
                                        "Java архитектор",
                                        "Организация процесса разработки системы ERP для разных окружений: релизная"
                                                + " политика, версионирование, ведение CI (Jenkins), миграция базы"
                                                + " (кастомизация Flyway), конфигурирование системы (pgBouncer, Nginx), AAA"
                        ...
                        Arrays.asList(
                                new Position(
                                        ...
                                        "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC,"
                                                + " SmartGWT, GWT, Jasper, Oracle). Реализация клиентской и серверной части"
                                                + " CRM. Реализация RIA-приложения для администрирования, мониторинга и"
                ...
                new Organization(
                        ...
                        Arrays.asList(
                                new Position(
                                        YearMonth.of(2008, 06),
                                        YearMonth.of(2010, 12),
                                        "Ведущий специалист",
                                        "Дизайн и имплементация Java EE фреймворка для отдела \"Платежные Системы\""
                                                + " (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI 2.1, Servlet 2.4, JSP, JMX,"
                                                + " JMS, Maven2). Реализация администрирования, статистики и мониторинга"
                                                + " фреймворка. Разработка online JMX клиента (Python/ Jython, Django,"
                                                + " ExtJS)"))),
                new Organization(
                        "Enkata",
                        null,
                        Arrays.asList(
                                new Position(
                                        YearMonth.of(2007, 03),
                                        YearMonth.of(2008, 06),
                                        "Разработчик ПО",
                                        "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0,"
                                                + " Tomcat, JMS) частей кластерного J2EE приложения (OLAP, Data"
                                                + " mining)."))),
                new Organization(
                        "Siemens AG",
                ...
                new Organization(
                        ...
                        Arrays.asList(
                                new Position(
                                        YearMonth.of(2011, 3),
                                        YearMonth.of(2011, 4),
                                        "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на"
                                                + " UML.'",
                                        null))),
                new Organization(
                        "Siemens AG",
    ...
    private static void printResume(Resume resume) {
        ...
        for (ContactType contactType : ContactType.values()) {
            Section content = resume.getContacts().get(contactType);
            if (content != null && content instanceof TextSection textContent) {
        ...
        for (SectionType sectionType : SectionType.values()) {
            ...
            if (section instanceof TextSection textContent) {
                System.out.println(textContent.text() + "\n");
            }

            if (section instanceof ListSection listContent) {
