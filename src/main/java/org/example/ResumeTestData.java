...
public class ResumeTestData {
    ...
    private static Resume createResume(String uuid, String fullName) {
        ...
        List<String> achievements =
                Arrays.asList(
                        ...
                        "Создание JavaEE фреймворка для отказоустойчивого взаимодействия слабо-связанных"
                                ...
                                + " онлайн клиента для администрирования и мониторинга системы по JMX"
                                + " (Jython/Django).",
        ...
        List<String> experience =
                Arrays.asList(
                        "Java Online Projects 10/2013 - Сейчас Автор проекта. Создание, организация и"
                                + " проведение Java онлайн проектов стажировок.",
                        "Wrike 10/2014 - 01/2016 Старший разработчик (backend) Проектирование и разработка"
                        ...
                        "RIT Center 04/2012 - 10/2014 Java архитектор Организация процесса разработки системы"
                                + " ERP для разных окружений: релизная политика, версионирование, ведение CI"
                                + " (Jenkins), миграция базы (кастомизация Flyway), конфигурирование системы"
                                + " (pgBoucer, Nginx), AAA via SSO. Архитектура БД и серверной части системы."
                                + " Разработка интергационных сервисов: CMIS, BPMN2, 1C  (WebServices), сервисов"
                                + " общего назначения (почта, экспорт в pdf, doc, html). Интеграция Alfresco JLAN"
                                ...
                                + " tunnels, PL/Python",
                        "Luxoft (Deutsche Bank) 12/2010 - 04/2012 Ведущий программист Участие в проекте"
                                + " Deutsche Bank CRM (WebLogic, Hibernate, Spring, Spring MVC, SmartGWT, GWT,"
                                + " Jasper, Oracle). Реализация клиентской и серверной части CRM. Реализация"
                                + " RIA-приложения для администрирования, мониторинга и анализа результатов в"
                                + " области алгоритмического трейдинга. JPA, Spring, Spring-MVC, GWT, ExtGWT (GXT),"
                                + " Highstock, Commet, HTML5.",
                        "Yota 06/2008 - 12/2010 Ведущий специалист Дизайн и имплементация Java EE фреймворка"
                                + " для отдела \"Платежные Системы\" (GlassFish v2.1, v3, OC4J, EJB3, JAX-WS RI"
                                + " 2.1, Servlet 2.4, JSP, JMX, JMS, Maven2). Реализация администрирования,"
                                + " статистики и мониторинга фреймворка. Разработка online JMX клиента (Python/"
                                + " Jython, Django, ExtJS)",
                        "Enkata 03/2007 - 06/2008 Разработчик ПО Реализация клиентской (Eclipse RCP) и"
                                + " серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE"
                                + " приложения (OLAP, Data mining).",
                        "Siemens AG 01/2005 - 02/2007 Разработчик ПО Разработка информационной модели,"
                        ...
                        "Alcatel 09/1997 - 01/2005 Инженер по аппаратному и программному тестированию"
                                + " Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 100 S12"
                                + " (CHILL, ASM).");
        sections.put(SectionType.EXPERIENCE, new ListSection(experience));

        List<String> education =
                Arrays.asList(
                        "Coursera 03/2013 - 05/2013 'Functional Programming Principles in Scala' by Martin"
                                + " Odersky",
                        "Luxoft 03/2011 - 04/2011 Курс 'Объектно-ориентированный анализ ИС. Концептуальное"
                        ...
                        "Санкт-Петербургский национальный исследовательский университет информационных"
                                + " технологий, механики и оптики 09/1993 - 07/1996",
